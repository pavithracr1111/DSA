...
int delete_at_first(Slist **head);              // function to delete at first
int delete_at_last(Slist **head);               // function to delete at last
int delete_list(Slist **head);               // function to delete list
